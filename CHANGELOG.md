...
- Added tracked monorepo placeholders for `apps/api`, `apps/cli`, `packages/database`, `packages/embeddings`, `packages/shared`, and `data`.
- Added `docs/architecture.md` to document the recommended FastAPI, Typer, Next.js, PostgreSQL, and vector-search direction for QuranKit.
